...
export class Rs2ModelDecoder {
    ...
    static async getModel(modelId: number): Promise<Rs2Model | null> {
        ...
        const model = new Rs2Model(modelId);
        ...
        for (let i = 0; i < model.vertexCount; i++) {
            ...
            if ((mask & 0x1) !== 0) {
                try {
                    ...
                    logger.warn('Tried to read out of range xOffset for object', modelId);
                }
            }
            ...
            if ((mask & 0x2) !== 0) {
                try {
                    ...
                    logger.warn('Tried to read out of range yOffset for object', modelId);
                }
            }
            ...
            if ((mask & 0x4) !== 0) {
                try {
                    ...
                    logger.warn('Tried to read out of range zOffset for object', modelId);
                }
            }
